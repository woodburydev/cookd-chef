  ...
  return (
    <View style={commonStyles.FlexColCenterCenter}>
      <View style={[styles.SectionStyle]}>
        <Text type="large-header" centerText>Grow Your Career With
          Cookd For Chefs</Text>
        <Image
          source={ChefImage}
        ...
        <View style={[styles.TextContainer, commonStyles.mb20]}>
          <Text type="large-header" centerText>Step 1:</Text>
          <Text style={commonStyles.mb20} type="large-header" centerText>Create Profile</Text>
          <Text type="description" centerText>Once your account is made, you’ll need to create a bio, menus and dishes to offer your Cookd Clients. </Text>
        </View>
        <Button
          onPress={submit}
          style={styles.Button}
