      ...
      <ScrollView>
        <View style={[styles.HeaderTextSection]}>
          <View style={styles.HeaderTextSectionContent}>
            <Text type="header" style={commonStyles.mx20}>
              Let's get you verified so you can start cooking!
            </Text>
            <Text style={commonStyles.mb20}>
              You can upload each section seperately and revisit the rest later.
            </Text>
          </View>
        </View>
        ...
        <View style={[styles.ContainerStyle]}>
          ...
          <View style={[styles.ButtonView, commonStyles.mb20]}>
            <Button mode="miniOrange" title="Front" />
            <Button mode="miniOrange" title="Back" />
            <Button mode="miniRed" title="Submit" />
          </View>
        </View>
        <View style={[styles.ContainerStyle]}>
          <Text
          ...
          <View style={[styles.ButtonView, commonStyles.mb20]}>
            <Button mode="miniOrange" title="Take Pic" />
            <Button mode="miniRed" title="Submit" />
        ...
        <View style={[styles.ContainerStyle]}>
          ...
          <View style={[styles.ButtonView, commonStyles.mb20]}>
            <Input
              ...
              shake={() => null}
            />
            <Button mode="miniRed" style={{marginTop: 15}} title="Submit" />
          </View>
        </View>
        <View style={[styles.ContainerStyle]}>
          <Text
