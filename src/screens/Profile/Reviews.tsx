...
export default function Reviews() {
  return (
    ...
    <View style={commonStyles.FlexColCenterStart}>
      <View style={[commonStyles.mx20, { backgroundColor: 'white', width: '100%', paddingBottom: 20, paddingTop: 20 }]}>
        <Text type="large-header" style={commonStyles.mb20} centerText>Your Reviews</Text>
      ...
      <View style={[styles.TouchableOpacityContainer, styles.WhiteBackgroundView, commonStyles.mb10]}>
        <View>
        ...
        <View style={{ marginLeft: 10 }}>
          ...
          <View style={[commonStyles.FlexColStartStart, commonStyles.mt5]}>
            ...
            <View style={[commonStyles.FlexRowStartStart, commonStyles.mb5]}>{[...Array(5).keys()].map(() => (
              <Icon
                type="font-awesome"
                name="star"
                size={11}
      ...
      <View style={[styles.TouchableOpacityContainer, styles.WhiteBackgroundView, commonStyles.mb10]}>
        <View>
          <Image source={User1} style={[styles.CardImageStyle]} containerStyle={{ marginLeft: 20 }} />
        </View>
        <View style={{ marginLeft: 10 }}>
          <Text type="label">Rob Kent</Text>
          <View style={[commonStyles.FlexColStartStart, commonStyles.mt5, styles.ReviewTextContainer]}>
            <Text style={styles.GrayText}>I found this chef to be one of the most professional, friendly, and inviting people I have come across in the personal chef business. Definitely a huge favorite, made great friends with him while he worked, and he made the most delicious food. Highly recommend</Text>
            <View style={[commonStyles.FlexRowStartStart, commonStyles.mb5]}>{[...Array(5).keys()].map(() => (
              <Icon
                type="font-awesome"
                name="star"
      ...
      <View style={[styles.TouchableOpacityContainer, styles.WhiteBackgroundView, commonStyles.mb10]}>
        ...
        <View style={{ marginLeft: 10 }}>
          ...
          <View style={[commonStyles.FlexColStartStart, commonStyles.mt5, styles.ReviewTextContainer]}>
            ...
            <Text style={styles.GrayText}>I had the most fantastic time when I ordered from this chef. I would highly recommend this to all of my friends, some of the best food I have ever eaten in my life.</Text>
            <View style={[commonStyles.FlexRowStartStart, commonStyles.mb5]}>{[...Array(5).keys()].map(() => (
              <Icon
                type="font-awesome"
                name="star"
