...
export default function TOS() {
  ...
  return (
    <ScrollView showsVerticalScrollIndicator={false}>
      <View style={[commonStyles.FlexColStartCenter, {padding: 20}]}>
        <Text style={styles.tcP}>
          ...
          with our privacy policy govern [business name]’s relationship with you in relation to this
          website. If you disagree with any part of these terms and conditions, please do not use
          our website.
        </Text>
        <Text style={styles.tcP}>
          The term ‘[business name]’ or ‘us’ or ‘we’ refers to the owner of the website whose
          registered office is [address]. Our company registration number is [company registration
        ...
        <Text style={styles.tcL}>
          ...
          cookies to be used, the following personal information may be stored by us for use by
        ...
        <Text style={styles.tcL}>
          ...
          materials found or offered on this website for any particular purpose. You acknowledge
        ...
        <Text style={styles.tcL}>
          ...
          own risk, for which we shall not be liable. It shall be your own responsibility to ensure
        ...
        <Text style={styles.tcL}>
          ...
          licensed to the operator, are acknowledged on the website. Unauthorised use of this
